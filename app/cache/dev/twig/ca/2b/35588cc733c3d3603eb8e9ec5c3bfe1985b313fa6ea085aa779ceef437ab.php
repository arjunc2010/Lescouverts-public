...
class __TwigTemplate_ca2b35588cc733c3d3603eb8e9ec5c3bfe1985b313fa6ea085aa779ceef437ab extends Twig_Template
{
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            // line 22
            echo "                                           <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("virtual_market_focus", array("id" => $this->getAttribute((isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")), "id"))), "html", null, true);
            echo "\">
            ...
            echo "</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class=\"product-value\">
                                                            <span>";
            // line 40
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")), "country"), "html", null, true);
            echo "</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class=\"product-value\">
                                                            <span>";
            // line 48
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")), "validFrom"), "m-d-Y"), "html", null, true);
            echo " - till - ";
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")), "validTill"), "d-m-Y"), "html", null, true);
            echo "</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class=\"product-value\">
                                                            <span style=\"
                                                                            ";
            // line 65
            if (($this->getAttribute((isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")), "discount") <= 30)) {
                // line 66
                echo "                                                                                 color:rgb(24,126,55);
                                                                            ";
            } elseif (($this->getAttribute((isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")), "discount") <= 60)) {
                // line 68
            ...
            echo "                                                                         \">
                                                                ";
            // line 73
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")), "discountPrice"), "html", null, true);
            echo " euros</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
            ...
            // line 95
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")), "discount"), "html", null, true);
