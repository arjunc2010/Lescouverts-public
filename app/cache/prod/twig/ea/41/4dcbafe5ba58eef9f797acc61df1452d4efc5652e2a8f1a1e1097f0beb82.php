...
class __TwigTemplate_ea414dcbafe5ba58eef9f797acc61df1452d4efc5652e2a8f1a1e1097f0beb82 extends Twig_Template
{
    ...
    public function block_hwi_oauth_content($context, array $blocks = array())
    {
        // line 4
        echo "    <h3>";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("header.register", array("%name%" => $this->getAttribute((isset($context["userInformation"]) ? $context["userInformation"] : null), "realName")), "HWIOAuthBundle"), "html", null, true);
        echo "</h3>
    <div class=\"row\">
        <div class=\"span6\">
            <form action=\"";
        ...
        <div class=\"span6\">
            ";
        // line 16
        if ((!twig_test_empty($this->getAttribute((isset($context["userInformation"]) ? $context["userInformation"] : null), "profilePicture")))) {
            // line 17
            echo "                <img src=\"";
