 ...
 */
class Comments extends \Les\DataBundle\Entity\Comments implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'restoID', 'userID', 'text', 'dateCreated', 'dateModified');
        }
