...
{
	?>
	<a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminBookings&amp;action=printPaper&amp;date=<?php echo urlencode($_GET['date']); ?>" target="_blank"><?php echo $RB_LANG['booking_print']; ?></a>
