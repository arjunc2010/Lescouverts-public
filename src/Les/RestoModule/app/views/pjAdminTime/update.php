		...
		<div id="tabs-1">
			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminTime&amp;action=index" method="post" class="form" id="frmTimeCustom">
				...
				<p>
					...
					<input type="text" name="date" id="date" class="text w100 pointer required pps" readonly="readonly" value="<?php echo pjUtil::formatDate($tpl['arr']['date'], 'Y-m-d', $tpl['option_arr']['date_format']); ?>" rel="<?php echo $week_start; ?>" rev="<?php echo $jqDateFormat; ?>" />
				</p>
				<?php
